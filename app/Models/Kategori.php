...
class Kategori extends Model
{
    ...
    public static function getKategoriAll()
    {
        return DB::table('kategori')
            ->select('kategori.id', 'deskripsi', DB::raw('ketKategorik(kategori) as ketkategorik'), 'kategori') // Add 'kategori' here
            ->get();
    }
    ...
    public static function showKategoriById($id){
        return DB::table('kategori')
                ...
                ->select('kategori.id','barang.id','kategori.deskripsi',DB::raw('ketKategorik(kategori.kategori) as ketkategorik'),
    ...
    public static function search($query){
        return DB::table('kategori')
            ->select('kategori.id', 'deskripsi', DB::raw('ketKategorik(kategori) as ketkategorik'), 'kategori')
